...
public class DriversController implements Initializable {
	...
	private  ObservableList<Drivers> data = FXCollections.observableArrayList();
	...
	@FXML
	private  TableView<Drivers> table = new TableView<Drivers>();
	...
	private void createTableColumn() throws ClassNotFoundException,
		...
		while (rs.next())
		{
			data.add(new Drivers(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getDouble(7), DateUtil.formatDate(rs.getString(8)), 
		...
		TableColumn firstNameCol = new TableColumn<Drivers, String>("First Name"); 
		firstNameCol.setMinWidth(100);
		firstNameCol.setCellValueFactory(new PropertyValueFactory<>("firstName"));

		TableColumn midNameCol = new TableColumn<Drivers, String>("Middle Name");
		midNameCol.setMinWidth(100);
		midNameCol.setCellValueFactory(new PropertyValueFactory<>("midName"));

		TableColumn lastNameCol = new TableColumn<Drivers, String>("Last Name");
		lastNameCol.setMinWidth(100);
		lastNameCol.setCellValueFactory(new PropertyValueFactory<>("lastName"));
		
		TableColumn lessRateCol = new TableColumn<Drivers, String>("Less Rate");
		lessRateCol.setMinWidth(100);
		lessRateCol.setCellValueFactory(new PropertyValueFactory<>("lessRate"));
		
		TableColumn address = new TableColumn<Drivers, String>("Address");
		address.setMinWidth(100);
		address.setCellValueFactory(new PropertyValueFactory<>("address"));

		TableColumn licenseNumber = new TableColumn<Drivers, String>("Licenses No.");
		licenseNumber.setMinWidth(100);
		licenseNumber.setCellValueFactory(new PropertyValueFactory<>("licenseNum"));
		
		TableColumn licenseExp = new TableColumn<Drivers, String>("Licenses Expire");
